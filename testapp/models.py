...
class InternationalCurrent(models.Model):
    ...
    feels_like = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    ...
    # wind
    wind_speed = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    wind_direction = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    # clouds
    cloud = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    # rain
    rain_one_hour = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    rain_three_hour = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    # snow
    snow_one_hour = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    snow_three_hour = models.DecimalField(max_digits=10, decimal_places=3, null=True)
...
class DomesticCurrent(models.Model):
    ...
    # 체감기온
    windchill_temp = models.DecimalField(max_digits=10, decimal_places=2, null=True)
    # 강수량 mm
    ...
    # 풍속
    wind_speed = models.DecimalField(max_digits=10, decimal_places=2, null=True)
